...
public:
    ...
    int GetProfiles(_trt__GetProfilesResponse &profiles, std::string customMediaUrl);
    int GetStreamUrl(std::string strToken, _trt__GetStreamUriResponse &url);
    int GetStreamUrl(std::string strToken, _trt__GetStreamUriResponse &url, std::string customMediaUrl);
...
inline int OnvifClientMedia::GetStreamUrl(std::string strToken, _trt__GetStreamUriResponse &url, std::string customMediaUrl)
{
    string strUrl;
    string strUser;
    string strPass;
    ...
    mediaProxy.soap_endpoint =  customMediaUrl.c_str();
...
inline int OnvifClientMedia::GetProfiles(_trt__GetProfilesResponse &profiles, std::string customMediaUrl)
{
    string strUser;
    string strPass;
    _trt__GetProfiles	profilesReq;
